...
#model = tf.keras.models.load_model('E:/Projects/Image Caption Generator/StreamLIt/best_model_1.h5')
#model = keras.models.load_model('E:/Projects/Image Caption Generator/StreamLIt/model-ep020-loss1.879.keras')
